class room3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.fastfood1=this.physics.add.sprite(fastfood1.x,fastfood1.y,'fastfood1Img').play('fries-anim').setScale(3)
        this.fastfood2=this.physics.add.sprite(fastfood2.x,fastfood2.y,'fastfood2Img').play('coke-anim').setScale(3)
