class room1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.dessert1=this.physics.add.sprite(dessert1.x,dessert1.y,'desset1Img').play('donut-anim').setScale(2)
        this.dessert2=this.physics.add.sprite(dessert2.x,dessert2.y,'dessert2Img').play('icecream-anim').setScale(3)
