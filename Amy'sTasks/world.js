...
this.sneaky.play();
   ...
   this.player = this.physics.add.sprite(660, 1260, 'amy').play("front-amy");
...
//
...

  {
   ...
   if ( this.player.x>240 && this.player.x<305 && this.player.y<1120 && this.player.y>1088 ){
     console.log("room3")
      this.room3();
   }
    
 if ( this.player.x>1081 && this.player.x<1145 && this.player.y<352 && this.player.y>288 ){
  console.log("room2")
  this.room2();
  }
